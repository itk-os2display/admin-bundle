 ...
 */
angular.module('ikShared').directive('ikSlideEditable', ['templateFactory', 'busService',
  function (templateFactory, busService) {
    ...
    return {
      ...
      templateUrl: 'bundles/os2displayadmin/apps/ikShared/elements/slide/slide-edit.html?' + window.config.version
    };
  }
]);
